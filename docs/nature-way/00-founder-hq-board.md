...
| Release / opérations | Runbook, checklist, callbacks et enveloppe de lancement documentés ; route de migration web inerte ; observabilité et staging à fermer                                                       | `PRODUCTION-RUNBOOK.md`, `LIVE-CUTOVER-CHECKLIST.md`, `docs/nature-way/09-launch-envelope.md`                                 | `blocked` pour release publique tant que la matrice staging n’est pas fermée | Engineering                  | Exécuter la matrice staging et fixer les seuils de rollout        | Risques : callbacks inline, variables d’environnement, réconciliation fournisseur           |
