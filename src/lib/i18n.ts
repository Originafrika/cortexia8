...
const fr: Dict = {
  ...
  "hero.subtitle": "Un accès unique aux meilleurs modèles — Kling, Seedance, Nano Banana, GPT-5, Claude, ElevenLabs — facturé à la génération. Payable en Mobile Money, carte, crypto ou Alipay. Où que tu crées.",
  ...
  "waitlist.no_spam": "Zéro spam. On t'écrit une fois pour te dire que c'est ouvert, une seconde pour t'offrir tes premiers crédits.",
  ...
  "waitlist.launch_email": "On t'écrit le 1er août avec ton accès. D'ici là, surveille ta boîte et ta place dans la file — elle bouge à chaque nouvel inscrit.",

  "sim.eyebrow": "Combien tu paierais",
  "sim.title.a": "Tape ton usage. Vois le prix.",
  "sim.title.b": "Pas l'inverse.",
  "sim.subtitle": "Les autres te vendent un forfait, puis te disent « attention aux limites ». Ici, tu paies exactement ce que tu utilises — à la seconde de vidéo, au caractère de voix, au token.",
  ...
  "sim.threshold_note": "À ce volume, un abonnement classique commence à être compétitif — mais tu ne payes toujours que ce que tu utilises, sans engagement, sans risque de payer pour rien un mois plus creux.",
  "sim.close_note": "Tu approches du seuil où un abonnement fixe redevient intéressant. Reste en usage tant que ton volume varie.",
  "sim.threshold_marker": "seuil abonnement",

  "wall.eyebrow": "Ce que Cortexia crée",
  "wall.title": "Le vrai bench, c'est ce qui sort.",
  "wall.subtitle": "Chaque case ci-dessous est un rendu réel d'un modèle du catalogue. Filtre par type ou par cas d'usage, ouvre pour voir le prompt.",
  ...
  "social.copy": "créateurs inscrits, de Lomé à Jakarta en passant par São Paulo et Paris. Le premier accès se fait par ordre d'inscription — le parrainage fait remonter.",
  ...
  "app.agent.hello_sub": "Je choisis le meilleur modèle, tu gardes la main. Chaque génération est facturée exactement au coût affiché.",
  ...
  "app.onb.step1.body": "Dis ce que tu veux — image, vidéo, voix, texte. Cortexia route ton prompt vers le meilleur modèle du catalogue et t'explique pourquoi.",
  "app.onb.step2.title": "Un playground par modèle.",
  "app.onb.step2.body": "Besoin de contrôle fin ? Va directement dans le catalogue et choisis ton modèle. Chaque page a son formulaire dédié et son prix live.",
  "app.onb.step3.title": "Zéro abonnement. Zéro surprise.",
  "app.onb.step3.body": "Le prix s'affiche avant chaque génération. Tu recharges ce que tu veux — Mobile Money, carte, crypto, Alipay — et tu repars quand tu veux.",
...
const en: Dict = {
  ...
  "hero.subtitle": "One entry point to the best models — Kling, Seedance, Nano Banana, GPT-5, Claude, ElevenLabs — billed per generation. Pay with Mobile Money, card, crypto or Alipay. Wherever you create.",
  ...
  "waitlist.no_spam": "Zero spam. One email when we open, a second one to hand you your first credits.",
  ...
  "waitlist.launch_email": "We'll email you on August 1st with your access. Meanwhile watch your inbox and your spot — it moves with every new signup.",

  "sim.eyebrow": "What you'd actually pay",
  "sim.title.a": "Type your usage. See the price.",
  "sim.title.b": "Not the other way around.",
  "sim.subtitle": "The others sell you a plan, then tell you to \"watch the limits\". Here, you pay exactly what you use — per second of video, per character of voice, per token.",
  ...
  "sim.threshold_note": "At this volume, a classic subscription starts to be competitive — but you still only pay what you use, with no commitment and no risk of paying for a quiet month.",
  "sim.close_note": "You're approaching the point where a flat subscription becomes worth it. Stay pay-as-you-go while your volume varies.",
  ...
  "wall.subtitle": "Every tile below is a real output from a catalog model. Filter by type or use case, tap to see the prompt.",
  ...
  "social.copy": "creators signed up, from Lomé to Jakarta via São Paulo and Paris. First access is by signup order — referrals move you up.",
  ...
  "app.agent.hello_sub": "I pick the best model, you stay in control. Every generation is billed at the shown cost.",
  ...
  "app.onb.step1.body": "Say what you want — image, video, voice, text. Cortexia routes your prompt to the best model in the catalog and tells you why.",
  "app.onb.step2.title": "A playground per model.",
  "app.onb.step2.body": "Need fine control? Head to the catalog and pick your model. Each has its own form and live pricing.",
  "app.onb.step3.title": "No subscription. No surprises.",
  "app.onb.step3.body": "The price shows before every generation. Top up what you want — Mobile Money, card, crypto, Alipay — leave whenever.",
  "app.onb.next": "Next",
  "app.onb.skip": "Skip",
...
const pt: Dict = {
  ...
  "hero.subtitle": "Um ponto de entrada para os melhores modelos — Kling, Seedance, Nano Banana, GPT-5, Claude, ElevenLabs — cobrado por geração. Pague com Mobile Money, cartão, cripto ou Alipay. Onde quer que você crie.",
  ...
  "waitlist.no_spam": "Sem spam. Um e-mail quando abrirmos, outro para te dar seus primeiros créditos.",
  ...
  "sim.threshold_note": "Neste volume, uma assinatura clássica começa a ser competitiva — mas você ainda só paga pelo que usa, sem compromisso, sem risco de pagar por um mês vazio.",
...
const es: Dict = {
  ...
  "hero.subtitle": "Un único acceso a los mejores modelos — Kling, Seedance, Nano Banana, GPT-5, Claude, ElevenLabs — facturado por generación. Paga con Mobile Money, tarjeta, cripto o Alipay. Donde quiera que crees.",
...
const id: Dict = {
  ...
  "hero.subtitle": "Satu akses ke model-model terbaik — Kling, Seedance, Nano Banana, GPT-5, Claude, ElevenLabs — dibayar per generasi. Bayar dengan Mobile Money, kartu, kripto atau Alipay. Di mana pun kamu berkarya.",
...
export const useLocaleStore = create<State>()(
  persist(
    (set) => ({
      ...
      setFromCurrency: (lang) =>
        set((s) => (s.langOverridden ? s : { lang })),
    }),
