          ...
          {pageCount > 1 && (
            <div className="mt-10 flex items-center justify-center gap-2">
              <button
                ...
                disabled={safePage === 1}
                className="inline-flex items-center gap-1 rounded-full border border-border bg-surface-1/50 px-3 py-1.5 text-xs disabled:opacity-40 hover:border-amber/40 transition"
              >
              ...
              <div className="flex items-center gap-1">
                {Array.from({ length: pageCount }).map((_, i) => (
                  <button
                    ...
                    onClick={() => setPage(i + 1)}
                    className={cn(
                      "size-8 rounded-full text-xs font-mono transition",
                      safePage === i + 1
