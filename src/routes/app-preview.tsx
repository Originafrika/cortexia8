...
export const Route = createFileRoute("/app-preview")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cortexia route ton prompt vers le meilleur modèle image, vidéo, voix ou texte. Payé à l'usage, sans abonnement." },
    ...
    <div className="relative min-h-screen">
      ...
      <footer className="mt-8 border-t border-border">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          ...
          <Link to="/app" className="hover:text-foreground transition inline-flex items-center gap-1">
