...
const endpoints = [
  {
    ...
    description:
      'Starts an image, video, or audio generation based on the chosen model. Returns immediately with `status: "processing"`. Poll `GET /v1/generations/:id` to retrieve the result URL once complete.',
    headers: [
