...
//#region node_modules/.nitro/vite/services/ssr/assets/i18n-BEBY8TOx.js
var LANGS = {
	fr: {
		name: "French",
		native: "Français",
...
var useLocaleStore = create()(persist((set) => ({
	lang: "fr",
...
//#endregion
export { useT as i, LANGS as n, useLocaleStore as r, CURRENCY_TO_LANG as t };
