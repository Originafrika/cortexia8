...
//#region node_modules/.nitro/vite/services/ssr/assets/app.models._slug-C1PEs1IQ.js
...
var SplitNotFoundComponent = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
		...
		children: "Modèle introuvable."
	}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
		to: "/app/models",
		className: "mt-4 inline-flex text-amber-soft hover:underline",
		children: "Retour au catalogue"
	})]
});
//#endregion
export { ModelPlaygroundContent, SplitNotFoundComponent as notFoundComponent };
