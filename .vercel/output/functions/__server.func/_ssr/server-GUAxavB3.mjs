...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BRoE8cMr.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D0Rns0g3.mjs"),
		import("./start-DZgY1m9l.mjs"),
		import("./empty-plugin-adapters-CmZW51xl.mjs")
	]);
	return {
		routerEntry,
		startEntry,
