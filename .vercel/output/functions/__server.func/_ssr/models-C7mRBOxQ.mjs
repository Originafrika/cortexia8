//#region node_modules/.nitro/vite/services/ssr/assets/models-C7mRBOxQ.js
var commonImageParams = [
	{
		kind: "prompt",
		label: "Prompt",
...
var commonVideoParams = [
	...
	{
		kind: "upload",
		label: "Image de départ (optionnel)"
	},
	{
		kind: "select",
		label: "Ratio",
		...
		params: [
			{
				kind: "prompt",
				label: "Texte à lire",
				placeholder: "Marie, calmement : « On tourne la scène de nuit demain. » Julien : « J'ai les storyboards. »"
			},
			{
				kind: "select",
				label: "Voix",
...
//#endregion
export { unitLabel as i, basePrice as n, getModel as r, MODELS as t };
